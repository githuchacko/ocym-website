...
export default function Contact() {
  ...
  return (
    <main className="p-4 sm:p-6 max-w-full sm:max-w-2xl mx-auto">
      <div className="mt-10 bg-gray-100 p-4 rounded-xl">
        ...
        <p className="text-black">ph: {secretary?.ph ? (
          <a className="text-blue-600 hover:underline" href={`tel:${(secretary.ph || '').replace(/\s+/g, '')}`}>{secretary.ph}</a>
        ) : 'N/A'}</p>
      </div>
